    ...
    <div class="flex -mx-4 items-center justify-between relative">
      <div class="w-60 max-w-full px-4">
        {{-- <a href="/" class="w-full flex items-center py-2">
          ...
          />
          <span class="text-xl xl:text-2xl font-bold text-[#0c7187] dark:text-white">Erik</span>
        </a> --}}
      </div>
      <div class="flex px-4 justify-end items-center w-full">
        <div>
          ...
          <nav
            ...
            id="navbarCollapse"
            class="absolute right-0 top-full bg-white py-5 px-6 z-50 shadow rounded-lg w-full dark:bg-slate-800 dark:text-gray-300 lg:px-0 lg:max-w-full lg:w-full lg:right-4 lg:block lg:static lg:shadow-none"
          >
