            ...
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    <h2
                        ...
                        PARA CONSULTAS DE NEGÓCIOS
                    </h2>
                    <p class="text-base text-body-color dark:text-gray-1 leading-relaxed mb-9">
                 ...
                 ">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color dark:text-gray-300">@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
                    <form action="/contact/submit" method="POST" x-data="{
                        ...
                        @csrf
                        <div class="mb-6">
                            <x-forms.input placeholder="Seu Nome" name="name" x-model="formData.name"
                        ...
                        <div class="mb-6">
                            <x-forms.input type="email" placeholder="Seu Email" name="email"
                        ...
                        <div class="mb-6">
                            <x-forms.textarea placeholder="Sua Mensagem" name="message" rows="6"
