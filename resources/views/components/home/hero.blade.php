<!-- ====== Hero Section Start -->
<div class="relative pt-[60px] lg:pt-[80px] pb-[110px] bg-white dark:bg-slate-700">
  <div class="container">
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
          Meu nome é Erik. <br/>
          Sou <span class="rounded-md text-amber-600">Desenvolvedor web</span>.
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            Sou um desenvolvedor com 1 ano de experiência. <br/>
            Sempre estou de olho nas novidades do mundo da tecnologia. <br/>
      ...
      <div class="w-full lg:w-6/12 px-4">
        <div class="lg:text-right lg:ml-auto">
          <div class="relative inline-block z-10 pt-11 lg:pt-0">
            <img
              src="{{ Vite::asset('resources/img/me_hero.png')}}"
              alt="hero"
